...
class Train(BaseTrain):
    def __init__(self,
        ...
        test_encoder = Encoder(self.decoder_input_size, data_train.state_size, window_size).to(self.device)
        test_decoder = Decoder(self.decoder_input_size).to(self.device)
